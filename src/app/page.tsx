...
// ─── ServiceVisual — pure bubble SVG composition, no text ────────────────────
  ...
  return (
    <section style={{ background: "var(--ink)", padding: "120px 0 140px" }}>
      <div className="wrap" style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        {/* Tab bar */}
        <div style={{ display: "flex", borderBottom: "1px solid rgba(255,255,255,0.08)", paddingBottom: 0, marginBottom: 56 }}>
          {services.map((s, i) => (
            <button
              key={s.num}
              onClick={() => setActive(i)}
      ...
      <div className="wrap" style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        <div style={{ position: "relative" }}>
          <AnimatePresence mode="wait">
            ...
            >
              <div style={{ display: "flex", background: "rgb(28,28,28)", borderRadius: 20, overflow: "hidden" }} className="testimonial-card">
                {/* Left: client */}
                <div style={{ width: "34%", flexShrink: 0, padding: "72px 40px 72px 64px", display: "flex", flexDirection: "column", justifyContent: "space-between" }} className="testimonial-left">
                  <div style={{ width: 80, height: 80, borderRadius: "50%", background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.12)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "var(--sans)", fontWeight: 700, fontSize: 22, color: "#fff", marginBottom: 64 }}>
                ...
                {/* Right: quote */}
                <div style={{ flex: 1, background: "rgb(21,21,21)", borderRadius: 20, padding: "80px 64px", display: "flex", alignItems: "center" }} className="testimonial-right">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 40 }}>
            <button onClick={prev} aria-label="Previous"
              style={{ width: 56, height: 56, borderRadius: "50%", background: "transparent", border: "1px solid rgba(0,0,0,0.2)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--ink)" }}
            ...
            <div style={{ display: "flex", gap: 8, marginLeft: 8 }}>
              {testimonials.map((_, i) => (
                <button key={i} onClick={() => setCurrent(i)} aria-label={`Testimonial ${i + 1}`}
                  style={{ width: i === current ? 40 : 14, height: 14, borderRadius: "0.625rem", background: i === current ? "var(--ink)" : "transparent", border: "1px solid rgba(0,0,0,0.25)", cursor: "pointer", transition: "width 0.3s ease, background 0.3s ease", padding: 0 }}
                />
              ))}
            </div>
  ...
  return (
    <>
      ...
      <main style={{ overflowX: "hidden" }}>
        ...
        >
          <motion.div style={{ position: "absolute", inset: "-20%", background: "var(--ink)", y: bgY }} />
          ...
          <div className="wrap" style={{ maxWidth: 1100, margin: "0 auto", width: "100%", position: "relative", zIndex: 1 }}>
            ...
            <h1 style={{ fontFamily: "var(--serif-display)", fontSize: "clamp(64px, 10vw, 118px)", lineHeight: 0.95, fontWeight: 700, letterSpacing: "-0.022em", marginTop: 22, marginBottom: 0, color: "var(--fg-on-ink)" }}>
          ...
          <div className="wrap" style={{ maxWidth: 1100, margin: "0 auto" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 56 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 12 }}>
                <span style={{ fontFamily: "var(--mono)", fontSize: 11, letterSpacing: "0.1em", color: "var(--fg3)", userSelect: "none" }}>drag to explore →</span>
          ...
          <div className="wrap" style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
            ...
            >
              <a
                ...
                style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "15px 30px", background: "#1a1a1a", border: "1px solid rgba(255,255,255,0.2)", color: "#fff", borderRadius: 10, fontFamily: "var(--sans)", fontWeight: 600, fontSize: 15, textDecoration: "none", transition: "background 0.18s ease-out" }}
