...
// Brand bubble — solid geometry (NOT a border ring), safe for clipPath.
// Portrait, large corner radii, sharp left-pointing tail.
const BUBBLE_PATH =
...
const BUBBLE_VB_W = 260;
const BUBBLE_VB_H = 300;
